...
// DRWMutexAcquireTimeout - tolerance limit to wait for lock acquisition
// before we check for quorum and relinquish locks if necessary.
// For slower nodes you might have bump up this value.
